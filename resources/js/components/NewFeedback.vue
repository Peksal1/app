...
<div class="card">
  <div class="card-header">
   New Feedback ff {{currentUser.id}}
  </div>
  <div class="card-body">
    <form action="#" @submit.prevent="createmessage">
    <div class="form-group">
      <input type="text" class="form-control" name="evaluation" placeholder="Evaluation" v-model="formData.evaluation">
...
methods:{
  createmessage(){
    this.formData.user_id=this.currentUser.id
      axios.post('/api/feedback',this.formData,{
            headers: {
