              ...
              <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="first_name" id="first_name" class="form-control input-lg"
                    placeholder="First Name" tabindex="1" required v-model="formData.name" />
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="last_name" id="last_name" class="form-control input-lg"
                    placeholder="Last Name" required tabindex="2" v-model="formData.surname" />
                </div>
              </div>
            </div>
            <div class="form-group">
              <input type="text" name="display_name" id="display_name" class="form-control input-lg"
                placeholder="Display Name" required tabindex="3" v-model="formData.display_name" />
            </div>
            <div class="form-group">
              <input type="email" name="email" id="email" class="form-control input-lg" placeholder="Email Address"
                tabindex="4" required v-model="formData.email" />
            </div>
            <div class="form-group">
              <input type="text" name="phone_number" id="phone_number" class="form-control input-lg"
                placeholder="Phone number" tabindex="4" required v-model="formData.phone_number" />
            </div>
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="password" name="password" id="password" class="form-control input-lg"
                    placeholder="Password" tabindex="5" required v-model="formData.password" />
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-md-6">
                <router-link :to="{ name: 'login' }">
                  <a class="btn btn-success btn-block btn-lg" style="color:black">Login</a>
                </router-link>
              </div>
            </div>
          </form>
