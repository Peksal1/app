        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="comment-widgets">
              <!-- Comment Row -->
              <div class="d-flex flex-row comment-row m-t-0" v-for="(comment, index) in comments" :key="index">
                <div class="p-2"><img :src="`/avatar/${comment.user.avatar}`" alt="user" width="50"
                    class="rounded-circle"></div>
                <div class="comment-text w-100">
                  <h6 class="font-medium"><strong> {{ comment.user.name }} </strong> </h6> <span
                    class="m-b-15 d-block">{{ comment.message }} </span>
                  <div class="comment-footer"> <span class="text-muted float-right">{{ comment.created_at }}</span>
                    <button type="button" style="color:white" class="btn btn-danger btn-sm">Delete</button> </div>
                </div>
              </div>
            </div>
            <form @submit.prevent="postMessage">
              <div class="form-group">
                ...
                <textarea v-model="formData.message" type="textarea" class="form-control" style="max-width:600px" />
              </div>
              <div class="form-group">
